...
$formattedPageNames = array(
    ...
    'facility.php' => 'Facility Details',
    'details.php' => 'Claim Details',
    'submit-report.php' => 'Submit Report'
);
...
if (strcmp($currentPage, 'index.php') === 0) {
    ...
    $pageTitle = $formattedPageNames[$currentPage];
}
?>
...
<head>
    ...
    <meta name="description" content="OS&D Claim Management supports drivers reporting OS&D claims, an administrative claim dashboard, and internal process management and claim status information.">
    <meta name="author" content="Ron Bodnar">

    <title><?php echo $pageTitle; ?> | OS&D Claim Management</title>
            ...
            <div class="d-flex justify-content-center align-items-center">
                <div class="dropdown">
                    <a href="#" class="text-mron d-flex align-items-center text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <span class="d-none d-sm-inline mx-1"><?php echo 'Demo Account'; //$user->getFullName(); 
                                                                ?></span>
                    </a>
                    <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser1">
                        ...
                        <li><a class="dropdown-item disabled" href="<?php echo getRelativePath(); ?>src/views/login.php" id="signOut">Sign out</a></li>
                    </ul>
                </div>
            ...
            <nav class="sidebar">
                <div>
                    ...
                    <div class="nav_list">
                        ...
                        <a href="<?php echo getRelativePath(); ?>src/views/submit-report.php" class="nav_link<?php echo ($directoryName === 'submit-report' ? ' active' : '') ?>">
