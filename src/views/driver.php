...
$claims = $database->getClaimsByDriverId($_GET['id']);
        ...
        <div class="card content mt-3">
            <div class="card-body table-responsive">
                <div class="pt-2">
                    <div class="row g-0">
                        ...
                        <div class="col-sm-2">
                            ...
                            <p style="font-size: 1rem;">Danone Deliveries</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row d-flex justify-content-start align-items-center pb-4" style="border-bottom: 1px solid var(--separator-line-color);">
                    <div class="col text-center"><?php echo $database->getOSDClaimCountByDriverId($_GET['id']); ?></div>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                        <div class="table-responsive">
                            <table class="table table-sm table-striped" id="driverClaimsTable" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>ID</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($claims as $claim) {
                                        ...
                                        echo '<td><a class="text-mron" href="facility.php?id=' . $claim['id'][3] . '">' . $claim['name'] . ' / ' . $claim['city'] . '</a></td>';
